...
import org.metaframework.apollo.props.ApolloProperties;
...
/**
 * @author sven
 * Created on 2023/7/16 2:55 PM
 */
@Slf4j
@Order
@Configuration(proxyBeanMethods = false)
public class MetaApolloChangeListenerConfiguration implements BeanPostProcessor {
    @Autowired
